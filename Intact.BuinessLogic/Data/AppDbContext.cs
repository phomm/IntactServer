...
public class AppDbContext : DbContext
{
    ...
    public DbSet<ProtoAbilityDao> ProtoAbilities { get; init; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        AddComputedLocalizableColumns<ProtoAbilityDao>();
        ...
        builder.Entity<ProtoAbilityDao>().Property(p => p.InitialPoints).HasDefaultValue(0);
